            ...
            <main class="main-content">
                <div class="login-register-area section-space-y-axis-100">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="http://localhost/ASM2/User-MAU/assets/images/login/img1.png" alt="">
                            </div>
                                    ...
                                    <div class="login-form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                ...
                                                <input class="input_dk" type="text" name="name_dk"
                                            ...
                                            <div class="col-md-6 col-12">
                                                ...
                                                <input class="input_dk" type="tel" name="tel_dk"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input class="input_dk" type="email" name="email_dk"
                                                    placeholder=" Email">
                                                <span class="err_form">
                                                    @if (isset($err['email']))
                                                        {{ $err['email'] }}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="input_dk" type="password" name="pass_dk"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="input_dk" type="password" name="repass_dk"
                                            ...
                                            <div class="adress">
                                                <select class="form-select form-select-sm mb-3" id="city"
                                                    aria-label=".form-select-sm" name="tinh">
                                                    <option value="" selected>Chọn tỉnh thành</option>
                                                </select>

                                                <select class="form-select form-select-sm mb-3" id="district"
                                                    aria-label=".form-select-sm" name="huyen">
                                            ...
                                            <div class="col-12">
                                                <button class="btn btn-custom-size lg-size btn-primary btn_dk"
                                                    name="submit_dk" style="width: 100%;">ĐANG KÝ</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
