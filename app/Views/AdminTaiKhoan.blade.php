                                    ...
                                    @foreach ($TaiKhoan as $key => $value)
                                        <tr>
                                            ...
                                            <td><a onclick="return confirm('Bạn chắc muốn xóa chứ ?')"
                                                    ...
                                                    href="http://localhost/ASM2/User-MAU/admin/delete/TaiKhoan/{{ $value->id }}">Xóa</a>
                                                @if ($value->trangthai == 0)
                                                    <a style="color: white; background: rgb(54, 218, 33); border-radius: 3px; padding: 5px"
                                                        href="http://localhost/ASM2/User-MAU/admin/edit/TaiKhoan/{{ $value->id }}">Mở
                                                        Khóa</a>
                                                @endif
                                                @if ($value->trangthai == 1)
                                                    <a style="color: white; background: rgb(132, 136, 7); border-radius: 3px; padding: 5px"
                                                        href="http://localhost/ASM2/User-MAU/admin/edit/TaiKhoan/{{ $value->id }}">Khóa</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
...
@if (isset($check['delete']) && $check['delete'] == true)
    <script>
        Swal.fire({
            ...
            icon: "success",
            willClose: () => {
                window.location.href = "http://localhost/ASM2/User-MAU/admin/TaiKhoan";
            }
        });
    </script>
@endif
