...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid"
                                            ...
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Mô
                                                        tả</label>
                                                    <textarea @if (isset($ERROR['moTa'])) style="border: 1px solid red" @endif class="form-control"
                                                        id="exampleFormControlTextarea1" rows="3" name="mota">{{ $valueInput['mota'] }}</textarea>
                                                    @if (isset($ERROR['moTa']))
                                                        <p style="color: red">
                                                            {{ '*' . $ERROR['moTa'] }}
                                                        </p>
                                                ...
                                                <div style="display: flex;">
                                                    ...
                                                    <div> <label for="formFile" class="form-label">SALE</label>
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input value="{{ $valueInput['sale'] }}"
                                                                @if (isset($ERROR['sale'])) style="border: 1px solid red" @endif
                                                                type="number" class="form-control" name="sale">
                                                        </div>
                                                        @if (isset($ERROR['sale']))
                                                            <p style="color: red">
                                                                {{ '*' . $ERROR['sale'] }}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        @if (isset($ERROR['img'])) style="border: 1px solid red" @endif
                                                        type="file" class="form-control" id="fileInput"
                                                        onchange="displayImage()" name="img">
                                                    @if (isset($ERROR['img']))
                                                        <p style="color: red">
                                                            {{ '*' . $ERROR['img'] }}
                                                        </p>
                                                ...
                                                <div><img id="selectedImage" alt="" height="150px"
                                                ...
                                                <div class="mb-3">
                                                    <button class="btn btn-primary" type="submit"
                                                        style="width: 100%;">Xác nhận thêm sản
                                                        phẩm</button>
                                                </div>
                                            </form>
    ...
    @if (isset($check) && $check['add'] == false)
        <script>
            Swal.fire({
                title: "Thêm thất bại",
